...
public class Constants {
	...
	public static final String ACCOUNT_UPDATED = "Account number has been successfully updated";
	public static final String ACCOUNT_REJECTED = "Account number has not been updated";
}
